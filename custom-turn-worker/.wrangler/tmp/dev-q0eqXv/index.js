...
// .wrangler/tmp/bundle-9jhu8L/checked-fetch.js
    ...
    return new Response(
      JSON.stringify({
        urls: creds.iceServers.urls.filter((urlString) => {
          ...
          return url2.protocol === "turn:" && url2.searchParams.get("transport") === "udp";
        }),
...
__name(getRefererURL, "getRefererURL");
...
// .wrangler/tmp/bundle-9jhu8L/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-9jhu8L/middleware-loader.entry.ts
